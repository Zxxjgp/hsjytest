...
//            return isEmpty(text) ? '' : text.split(/(\\|\/)/g).pop().replace(/[^\w\-.\\\/ ]+/g, '');
        	return isEmpty(text) ? '' : text.split(/(\\|\/)/g).pop(); //支持中文开头
        },
    ...
    $.fn.fileinput.locales.en = {
        ...
        uploadLabel: '上传',
        uploadTitle: '上传选中文件',
        msgSizeTooLarge: '文件 【{name}】 (<b>{size} KB</b>) 大于 <b>{maxSize} KB</b>，请重新上传！',
        ...
        msgInvalidFileExtension: '不支持的文件类型【{name}】. 请上传以下格式文件： {extensions}！ ',
