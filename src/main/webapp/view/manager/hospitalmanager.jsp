    ...
    <script type="text/javascript">
        ...
        function deleteLink(){
            ...
            $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
                if(r){
                    $.post("${pageContext.request.contextPath}/hospital/delete",{ids:ids},function(result){
                        if(result.success){
        ...
        function openLinkAddDialog(){
            $("#dlg").dialog("open").dialog("setTitle","添加医院信息");
            url="${pageContext.request.contextPath}/hospital/adds";
        }

        function opensearchLink(){
            $("#dlgs").dialog("open").dialog("setTitle","医院搜索");
            url="${pageContext.request.contextPath}/hospital/searchhospital?hospitalNames=";
        }
        ...
        function openLinkModifyDialog(){
            ...
            $("#dlg").dialog("open").dialog("setTitle","更新医院信息");
            $("#fm").form("load",row);
            url="${pageContext.request.contextPath}/hospital/adds?id="+row.id;
        }
        ...
        function saveLinks(hospitalNames){
            $("#fms").form("submit",{
                url:url+hospitalNames,
                onSubmit:function(){
                    return $(this).form("validate");
                },
                success:function(result){
                    ...
                    if(r.success){
                        ...
                        window.location.href="${pageContext.request.contextPath}/hospital/pagejump?hospitallists="+hospitalNames;
...
<table id="dg" title="医院管理" class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="hospitalName" width="200" align="center">医院名称</th>
        <th field="hospitalRegion" width="200" align="center">所属区域</th>
    </tr>
    </thead>
</table>
<div id="tb">
    ...
    <form id="fms" method="post">
        <table cellspacing="8px">
            <tr>
                <td>医院名字：</td>
                <td>
                    <input type="text" id="hospitalNames" name="hospitalNames" class="easyui-validatebox"  required="true" style="width: 250px"/>
                </td>
            </tr>
        </table>
    </form>
...
<div id="dlg-bu">
    <a href="javascript:saveLinks( $('#hospitalNames' ).val() )" class="easyui-linkbutton" iconCls="icon-ok">搜索</a>
