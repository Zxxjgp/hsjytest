...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="${pageContext.request.contextPath}/static/image/82839-106.jpg" alt="第一张">
        </div>
        <div class="item">
            <img src="${pageContext.request.contextPath}/static/image/105905-106.jpg" alt="第二张">
        </div>
        <div class="item">
            <img src="${pageContext.request.contextPath}/static/image/296494-106.jpg" alt="第三张">
        </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.stateCode.trim() == "0") {
                            ...
                            window.location.href="/view/manager/main";
                        }
                    }
                });
            }
